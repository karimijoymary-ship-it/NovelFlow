...
const ManualBookForm = ({ onClose, onSuccess }) => {
 ...
 <button type="button" onClick={onClose} style={{ background: 'transparent', border: 'none', color: 'var(--text)', fontSize: '1rem', cursor: 'pointer', padding: '2px 6px' }} title="Close">X</button>
 </div>
