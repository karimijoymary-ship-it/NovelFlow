...
function Sidebar({ activeView, onViewChange, user, onLogout, onOpenGuide }) {
  const sections = [
    {
      category: 'WORKSPACE',
      items: [
        { id: 'Discovery', label: 'Discovery', icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /> },
        { id: 'Catalog', label: 'Catalog', icon: <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /> },
    ...
    },
    {
      category: 'PERSONAL',
      items: [
        { id: 'My Library', label: 'My Library', title: 'Book Level: Update Page Count, Change Status, Filter by Completion.', icon: <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v-15H6.5A2.5 2.5 0 0 0 4 4.5v15z" /> },
        { id: 'Reading Stats', label: 'Reading Stats', icon: <path d="M12 20V10M18 20V4M6 20v-4" /> },
        { id: 'Collections', label: 'Collections', title: 'Theme Level: Academic Folders & DNA Preset Clusters.', icon: <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /> },
        { id: 'Saved Pages', label: 'Saved Pages', title: 'Passage Level: Highlights, Bookmarks, and Academic Citations.', icon: <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" /> }
      ]
    }
  ];
    ...
    <nav className="global-sidebar">
      ...
      <div className="global-sidebar-footer">
        <div style={{ display: 'flex', gap: '6px', alignItems: 'center', width: '100%' }}>
          ...
          {/* USER GUIDE HELP ICON BUTTON */}
          <button
            type="button"
            className="nav-item"
            onClick={onOpenGuide}
            title="Open User Guide & Help Manual"
            style={{ width: '36px', height: '36px', padding: 0, justifyContent: 'center', background: 'var(--accent-bg)', border: '1px solid var(--accent-border)', borderRadius: '8px', color: 'var(--accent)', fontWeight: 700 }}
          >
            ?
          </button>
        </div>

        <button className="nav-item text-danger" onClick={onLogout} style={{ marginTop: '4px' }}>
